...
const seed = async () => {
  try {
    ...
    await database.query(
      "INSERT INTO user (firstname, lastname, birthdate, mail, password, role_id) VALUES ('toto', 'toto', '1999-01-01', 'admin@admin.fr', '$argon2id$v=19$m=19456,t=2,p=1$pSMle1OHx9/EHHJavfLQ5A$3wGyCdRhWPmGwxyECzbCglUnxWAa4oVvAkLKEF2PQTE', 2)"
    );
